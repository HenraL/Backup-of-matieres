...
print("Niveau carburant voiture 2: {}".format(voiture2.niveau_carburant))
print("Kilomètre parcourus voiture2 : {}".format(voiture2.compteur_km))

print("Niveau carburant voiture 3: {}".format(voiture3.niveau_carburant))
print("Kilomètre parcourus voiture3 : {}".format(voiture3.compteur_km))