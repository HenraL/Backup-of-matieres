...
class Niveau:
    ...
    def afficher(self, fenetre):
    	...
    	aright = pygame.image.load(aright).convert_alpha()
    	aleft = pygame.image.load(aleft).convert_alpha()
    	aup = pygame.image.load(aup).convert_alpha()
    	adown = pygame.image.load(adown).convert_alpha()
...
class Perso:
    ...
    def __init__(self, droite, gauche, haut, bas, niveau):#,Loupsx,Loupsy
	...
	self.case_y=0
	self.case_x=0
	self.x = 0 #Loupsx #self.
	self.y = 0 #Loupsy #self.
