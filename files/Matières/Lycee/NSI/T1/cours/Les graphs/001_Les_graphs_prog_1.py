...
noeud_AA=noeud("A","A1","A2","A3","A4")
noeud_BB=noeud("B","B1","B2","B3","B4")
noeud_CC=noeud("C","C1","C2","C3","C4")
noeud_DD=noeud("D","D1","D2","D3","D4")
# liaison manuelle:
# (visualisez chaque nouvelle ligne sous python tutor)
...
print("XY")
print("  A B C D")
print("A",noeud_AA.pointeur_voisin1,noeud_BB.pointeur_voisin1,noeud_CC.pointeur_voisin1,noeud_DD.pointeur_voisin1)
print("B",noeud_AA.pointeur_voisin2,noeud_BB.pointeur_voisin2,noeud_CC.pointeur_voisin2,noeud_DD.pointeur_voisin2)
print("C",noeud_AA.pointeur_voisin3,noeud_BB.pointeur_voisin3,noeud_CC.pointeur_voisin3,noeud_DD.pointeur_voisin3)
print("D",noeud_AA.pointeur_voisin4,noeud_BB.pointeur_voisin4,noeud_CC.pointeur_voisin4,noeud_DD.pointeur_voisin4)
print("YX")
print("  A B C D")
print("A",noeud_A.pointeur_voisin1,noeud_A.pointeur_voisin2,noeud_A.pointeur_voisin3,noeud_A.pointeur_voisin4)
print("B",noeud_B.pointeur_voisin1,noeud_B.pointeur_voisin2,noeud_B.pointeur_voisin3,noeud_B.pointeur_voisin4)
print("C",noeud_C.pointeur_voisin1,noeud_C.pointeur_voisin2,noeud_C.pointeur_voisin3,noeud_C.pointeur_voisin4)
print("D",noeud_D.pointeur_voisin1,noeud_D.pointeur_voisin2,noeud_D.pointeur_voisin3,noeud_D.pointeur_voisin4)
print("YX")
print("  A B C D")
print("A",noeud_AA.pointeur_voisin1,noeud_AA.pointeur_voisin2,noeud_AA.pointeur_voisin3,noeud_AA.pointeur_voisin4)
print("B",noeud_BB.pointeur_voisin1,noeud_BB.pointeur_voisin2,noeud_BB.pointeur_voisin3,noeud_BB.pointeur_voisin4)
print("C",noeud_CC.pointeur_voisin1,noeud_CC.pointeur_voisin2,noeud_CC.pointeur_voisin3,noeud_CC.pointeur_voisin4)
