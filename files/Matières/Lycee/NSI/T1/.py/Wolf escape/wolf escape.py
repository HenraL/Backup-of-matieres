...
while continuer:
		...
		for event in pygame.event.get():
			...
			if event.type == QUIT or event.type == KEYDOWN and event.key == K_ESCAPE:
				...
				#Lancement du niveau 2
					...
					continuer_accueil = 0
					choix = 'n4'
				elif event.key == K_q: continuer_accueil,continuer_jeu,continuer,choix = 0,0,0,0
	...
	if choix != 0:
		...
		dk = Perso("img/dk_droite.png", "img/dk_gauche.png", "img/dk_haut.png", "img/dk_bas.png", niveau)
